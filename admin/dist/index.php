...
<body>
  ...
  <div class="app-container">
    <div class="sidebar">
      ...
      <ul class="sidebar-list">
        ...
        <li class="sidebar-list-item active">
          <a href="#" onclick="cargarContenido('inventario.html')">
        ...
        <li class="sidebar-list-item">
          <a href="#" onclick="cargarContenido('estado_pedido.php')">
      ...
      <div class="account-info">
        <div class="account-info-picture">
          <img src="../../assets/image/administrator.png" alt="Account">

        </div>
        <div class="account-info-name">

          <?php if (isset($_SESSION['admin_name'])) : ?>
            <p class="nombreAd"><?php echo $_SESSION['admin_name']; ?></p>
          <?php endif; ?>
        ...
        <div class="accionBt">
          ...
          <button class="account-info-more" onclick="openModal()" style="cursor: pointer;">
    ...
    <div class="app-content">
      ...
      <div class="products-area-wrapper tableView" id="panel" class="content">
  ...
  <script>
    function openModal() {
      document.getElementById("myModalito").style.display = "block";
    }

    function closeModal() {
      document.getElementById("myModalito").style.display = "none";
    }
  </script>
  ...
  <script>
    ...
    window.onload = function() {
      ...
      if (seccionActual) {
        ...
        cargarContenido('index.php'); // Si no hay página guardada, cargar panel_admin.php por defecto
      }
    };
